                ...
                VStack {
                    ...
                    ZStack {
                        ...
                        Button("Accept") {}
                            ...
                            .padding(.vertical, 10)
                            .background(Color(red: 0.966, green: 0.794, blue: 0.468))
                        ...
                        Button("Pass") {}
                            ...
                            .padding(.vertical, 10)
                            .background(Color(hue: 0.109, saturation: 0.427, brightness: 0.961))
                            .foregroundColor(Color.black)
                            .cornerRadius(7)
                            .font(.system(size: 15, weight: .bold))
                            .offset(x: 80, y:65)
                        ...
                        ZStack {
                            Rectangle()
                                ...
                                .cornerRadius(3)
                                .offset(x: 40, y: -21)
                                .foregroundColor(Color(red: 0.984, green: 0.833, blue: 0.551))
                            Text("CS")
                                .offset(x: 40, y: -21)
                                .font(.system(size: 15, weight: .bold))
